...
echo "  Sync into src:       ./scripts/theme-sync-from-pull.sh   # overwrites src/ config, templates, sections, layout"
echo "  Or copy by hand:     cp $PULL_DIR/config/* src/config/  etc."
