/**
 * colorflexPaletteHook.js — minimal, reversible hook for testing palette engine inside ColorFlex.
 *
 * Does not change layer loading or rendering logic; only writes into existing layer inputs
 * when the user clicks Apply, via CFM’s applyColorsToLayerInputs (exposed on window).
 *
 * Enable UI: ?paletteEngineTest=1  or  localStorage.paletteEngineTest = "1"
 */
